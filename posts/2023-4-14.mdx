...
import mypic from '/images/bible.jpg'
const MyImage = (props) => {
  return (
    <Image
      src={mypic}
...
![The Bible](https://unsplash.com/photos/Cy5dya5MAlI)

<iframe width="560" height="315" src="https://www.youtube.com/embed/zizT6xdjz4c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
